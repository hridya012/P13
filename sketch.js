...
var bowImage, score, arrowImage, green_balloonImage, red_balloonImage, pink_balloonImage ,blue_balloonImage, backgroundImage;
...
function pinkBalloon() {
  ...
  var pink = createSprite(0,Math.round(random(20, 400)), 10, 10);
